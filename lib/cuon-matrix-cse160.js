...
class Vector3 {
  ...
  static dot(other1, other2) {
      // Insert your code here.
      const d = other1.elements[0] * other2.elements[0] +
  ...
  static cross(other1, other2) {
      ...
      const x1 = other1.elements[0];
      const y1 = other1.elements[1];
      const z1 = other1.elements[2];
  
      const x2 = other2.elements[0];
      const y2 = other2.elements[1];
      const z2 = other2.elements[2];
